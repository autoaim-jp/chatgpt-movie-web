...
画像は、タイトルとページ数の分を必ず用意したいです。画像生成プロンプトの例のように、コロンを使ってください。
`

setting.prompt.STORY_VER2 = `【物語の要望】と【ユーザ要望】に従って、絵本に使う【物語】を作成してください。その後、【ナレーションcsvのルール】に従い、【ナレーションcsvの例】を参考に、【物語】を【ナレーションcsv】に変換して表示してください。最後に、【物語の要望】【ユーザ要望】【物語】【条件】に従って、【画像生成プロンプトyamlのルール】に従い、【画像生成プロンプトyamlの例】を参考に、絵本の表紙と各ページごとに画像を表示するための【画像生成プロンプトyaml】を作成してください。全体を通して、【前提】は守ってください。
改めて整理すると、生成してほしいのは以下の3つです。
【物語】【ナレーションcsv】【画像生成プロンプトyaml】
...
1行目は以下のようにする。
title_page: ...
次の行からは以下のように連番のキーで出力する。
page1: ...
page2: ...

【画像生成プロンプトyamlの例】
title_page: Create an image...
page1: Create an image...
